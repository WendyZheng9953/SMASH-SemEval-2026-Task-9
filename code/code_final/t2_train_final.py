...
def main():
    ...
    parser.add_argument("--train_dir", type=str, default="../dev_phase/subtask2/train/")

    parser.add_argument("--model_name", type=str, default="xlm-roberta-large")
    parser.add_argument("--from_checkpoint", type=str, default=None)

    parser.add_argument("--output_dir", type=str, default="fine-tuned_BERT/task2_multilingual/")
