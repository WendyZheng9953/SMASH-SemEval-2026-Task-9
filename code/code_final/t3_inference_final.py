...
class PolarizationTypeDataset(torch.utils.data.Dataset):
    def __init__(self, texts, labels, tokenizer, max_length=128):
        self.texts = texts
        self.labels = labels  # dummy for inference
...
def main():
    ...
    parser.add_argument("--input_dir", type=str, default="../dev_phase/subtask3/dev/",
    ...
    parser.add_argument("--output_dir", type=str, default="inference_logits/subtask3/",
                        help="Where to save <lang>.csv with logits column")
    ...
    for lang in args.languages:
        ...
        dummy_labels = np.zeros((len(texts), NUM_LABELS), dtype=float)

        dataset = PolarizationTypeDataset(
            texts,
            dummy_labels.tolist(),
            tokenizer,
